...
print('=== Training Production Business Entity Resolution Model ===')
...
# 2. Select 50,000 Training S1 records (strictly disjoint from validation)
train_s1_ids = []
with open('student_resource/dataset/train/train_ground_truth.tsv', 'r', encoding='utf-8') as f:
    f.readline()
    for line in f:
...
# 4. Load Target records (True targets + 80,000 distractors)
...
val_cand_recall = retrieved_val_true / total_val_true

print('\n' + '=' * 60)
print('FINAL PRODUCTION MODEL VALIDATION RESULTS')
print('=' * 60)
...
model_path = 'models/final_entity_matcher.joblib'
...
print(f'Model saved to {model_path} and metadata to models/model_metadata.json.')
