...
print('=== Training and Saving Best Validated Entity Resolution Model ===')
...
# Load 25,000 training S1 records (strictly disjoint from val)
train_s1_ids = []
with open('student_resource/dataset/train/train_ground_truth.tsv', 'r', encoding='utf-8') as f:
    f.readline()
    for line in f:
...
print('\n' + '=' * 60)
print('VALIDATION METRICS FOR PRODUCTION MODEL')
print('=' * 60)
...
model.save('models/final_entity_matcher.joblib')
